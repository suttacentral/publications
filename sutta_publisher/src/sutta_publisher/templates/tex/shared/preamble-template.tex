...
% If specifying semibold, the italic must be defined. I have removed it for now, because of style and because the \textsanskrit command was forcing a bold font and I couldn't figure out how to fix it. UPDATE: try using for Vinaya rules
...
\newcommand*{\scrule}[1]{{\Semiboldnormalfont{#1}}}
