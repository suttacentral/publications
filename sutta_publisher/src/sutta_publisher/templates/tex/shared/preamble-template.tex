...
\renewcommand*\l@part[2]{%
  \ifnum \c@tocdepth >-2\relax
    ...
    \begingroup
      ...
      {\leavevmode
       \begin{center}\setstretch{.85}\large\scshape #1\vspace*{-1em}\end{center}\llap{#2}}\par
       \nobreak
         \global\@nobreaktrue
...
\newcommand*\l@pannasa[2]{%
  \ifnum \c@tocdepth >-2\relax
    ...
    \begingroup
      ...
      \parfillskip -\@pnumwidth
      {\leavevmode
       \begin{center}\setstretch{.85}\large\itshape\scshape\lowercase{#1}\vspace*{-1em}\end{center}\llap{#2}}\par
       \nobreak
         \global\@nobreaktrue
         \everypar{\global\@nobreakfalse\everypar{}}%
    \endgroup
