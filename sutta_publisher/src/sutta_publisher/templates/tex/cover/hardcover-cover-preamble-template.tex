...
\newcommand*{\spinevolumenumber}[1]{\centering{\color{secondarytextcolor}{\scshape\LARGE{#1}}}}%
...
\BLOCK{if flat_background}
\newcommand*{\coverimage}[1]{\vspace*{1.5in}\hspace*{2in}{\includegraphics[height=8in]{\VAR{temp_directory | safe}background-image.jpg}}}
\BLOCK{endif}
