...
\arrayrulecolor{secondarytextcolor}
...
\newcommand*{\spinetranslationtitle}[1]{\setstretch{.7}\flushright\lowercase{\scshape\LARGE{#1}}}

\newcommand*{\spinecreatorname}[1]{\setstretch{.7}\flushleft\lowercase{\scshape\LARGE{#1}}}
