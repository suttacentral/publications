...
%\newfontfamily\Noligaturefont[Renderer=Basic]{ArnoPro-Caption}
...
\fancyhead[CE]{\setstretch{.85}\MakeLowercase{\caps{\firstrightmark}}}
\fancyhead[CO]{\setstretch{.85}\MakeLowercase{\caps{\firstleftmark}}}
